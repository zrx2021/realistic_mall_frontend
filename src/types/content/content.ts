    ...
    objData: {
      ...
      goodsList: [
        ...
        },
        {
          ...
          price: 14999,
          originalPrice: 15999,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=MacBook+Pro',
          stock: 25,
          sales: 567,
          rating: 4.9,
          tags: ['新品', '专业'],
        ...
        },
        {
          ...
          price: 5399,
          originalPrice: 5899,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=iPad+Air',
          stock: 40,
          sales: 892,
          rating: 4.7,
          tags: ['热销', 'M1'],
        ...
        },
        {
          ...
          price: 2399,
          originalPrice: 2699,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=Sony+WH1000XM5',
          stock: 60,
          sales: 1456,
          rating: 4.8,
          tags: ['降噪', '音质'],
        ...
        },
        {
          ...
          price: 1688,
          originalPrice: 1888,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=华为Watch+GT4',
          stock: 80,
          sales: 723,
          rating: 4.5,
          tags: ['智能', '健康'],
        ...
        },
        {
          ...
          price: 2599,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=Nintendo+Switch',
          stock: 35,
          sales: 445,
          rating: 4.6,
          tags: ['游戏', 'OLED'],
        ...
        },
        {
          ...
          price: 1699,
          originalPrice: 1899,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=小米空气净化器',
          stock: 45,
          sales: 678,
          rating: 4.6,
          tags: ['智能', '净化'],
        ...
        },
        {
          ...
          price: 2999,
          originalPrice: 3499,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=美的空调',
          stock: 30,
          sales: 234,
          rating: 4.4,
          tags: ['节能', '静音'],
        ...
        },
        {
          ...
          price: 899,
          originalPrice: 1199,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=九阳破壁机',
          stock: 55,
          sales: 1123,
          rating: 4.7,
          tags: ['热销', '营养'],
        ...
        },
        {
          ...
          price: 399,
          originalPrice: 499,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=飞利浦电动牙刷',
          stock: 80,
          sales: 1567,
          rating: 4.5,
          tags: ['清洁', '健康'],
        ...
        },
        {
          ...
          price: 799,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=宜家书桌',
          stock: 25,
          sales: 156,
          rating: 4.3,
          tags: ['实木', '收纳'],
        ...
        },
        {
          ...
          price: 1299,
          originalPrice: 1499,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=松下电饭煲',
          stock: 40,
          sales: 445,
          rating: 4.8,
          tags: ['智能', 'IH'],
        ...
        },
        {
          ...
          price: 2199,
          originalPrice: 2699,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=乳胶床垫',
          stock: 15,
          sales: 89,
          rating: 4.6,
          tags: ['舒适', '防螨'],
        ...
        // 服装美妆类商品
        {
          ...
          price: 599,
          originalPrice: 799,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=优衣库羽绒服',
          stock: 60,
          sales: 1234,
          rating: 4.5,
          tags: ['保暖', '时尚'],
        ...
        },
        {
          ...
          price: 1690,
          originalPrice: 1890,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=SK-II神仙水',
          stock: 30,
          sales: 567,
          rating: 4.8,
          tags: ['护肤', '精华'],
        ...
        },
        {
          ...
          price: 899,
          originalPrice: 1199,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=Nike+Air+Max',
          stock: 45,
          sales: 892,
          rating: 4.6,
          tags: ['运动', '潮流'],
        ...
        },
        {
          ...
          price: 780,
          originalPrice: 880,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=雅诗兰黛小棕瓶',
          stock: 25,
          sales: 445,
          rating: 4.7,
          tags: ['抗老', '修护'],
        ...
        // 秒杀商品
        {
          ...
          price: 199,
          originalPrice: 299,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=小米手环8',
          stock: 100,
          sales: 2345,
          rating: 4.4,
          tags: ['秒杀', 'NFC'],
        ...
        },
        {
          ...
          price: 89,
          originalPrice: 129,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=坚果礼盒',
          stock: 200,
          sales: 3456,
          rating: 4.3,
          tags: ['秒杀', '健康'],
        ...
        },
        {
          ...
          price: 69,
          originalPrice: 89,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=特仑苏牛奶',
          stock: 150,
          sales: 1789,
          rating: 4.5,
          tags: ['营养', '家庭装'],
        ...
        },
        {
          ...
          price: 128,
          originalPrice: 168,
          imageUrl: 'https://via.placeholder.com/300x300/f0f0f0/666?text=零食大礼包',
          stock: 80,
          sales: 1123,
          rating: 4.2,
          tags: ['零食', '礼包'],
